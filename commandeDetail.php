...
<head>
    ...
    <link rel="stylesheet" href="monCompte/commandeDetail/commandeDetailStyle.css">
</head>
...
<body>
    ...
    <div>
        ...
        <div  class="init-password">
            <div ng-include="'monCompte/commandeDetail/commandeDetailView.html'"></div>
        </div>
    ...
    <script src="monCompte/commandeDetail/commandeDetailCtrl.js"></script>
