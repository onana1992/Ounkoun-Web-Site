angular.module('App')
  .controller('AideProposCtrl', function ($scope,PanierFactory,FavorisFactory,baseUrl,AuthFactory,$http,$interval,$location,$anchorScroll,$rootScope,$location,$timeout,$routeParams) {
