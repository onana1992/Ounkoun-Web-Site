...
<head>
    ...
    <link rel="stylesheet" href="activation/activationStyle.css">
    ...
    <script src="inscription/inscriptionCtrl.js"></script>
    <script src="activation/activationCtrl.js"></script>
...
<body>
    ...
    <div  class="init-password">
        <div ng-include="'activation/activationView.html'"></div>
    </div>
