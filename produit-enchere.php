...
<head>
    ...
    <title><?php echo $_GET['nom']." au meilleur prix chez Ounkoun Cameroun";?></title>

    <?php 
           
           $url = "https://node16375-ounkoun1.hidora.com/backend/web/app_dev.php/enchere_one/";
           $url =$url.''.urlencode($_GET['numEnchere']);
           ...
           $imageUrl= "https://node16375-ounkoun1.hidora.com/backend/web/app_dev.php/image/".$result->response->idImage;

            $url= "https://www.ounkoun.com/produit-enchere.php?numEnchere=".$_GET['numEnchere'];
            $description= "Retrouver en vente aux enchères sur Ounkoun le produit ".$result->response->name.": Mise à prix:".$result->response->initPrice." FCFA";  
    ?>
    ...
    <meta property="og:title"              content="<?php echo "Encherir sur le produit ".$result->response->name;?>" />
    ...
    <script type="text/javascript">
        ...
        if(screen.width<800){
            window.location="https://www.ounkoun.com/m/#/enchere/"+getUrlVars()["numEnchere"];
        }
    </script>enchere/
   ...
   <!--  <link rel="stylesheet" href="dist/scripts/ext/lity.min.css"> -->
    <link rel="stylesheet" href="app.css">
    <link rel="stylesheet" href="nav/nav.css">
    <link rel="stylesheet" href="foot/foot.css">
    <link rel="stylesheet" href="produit/produitStyle.css">
    ...
    <script src="dist/scripts/ext/angular-socialshare.js"></script>
    <!-- <script src="dist/scripts/ext/lity.min.js"></script> -->

    <script src="app.js"></script>
    <script src="MainController.js"></script>
    <script src="home/homeCtrl.js"></script>
    <script src="nav/navCtrl.js"></script>
    <script src="produit/produitCtrl.js"></script>
...
<body>
    ...
    <div>  
        ...
        <!-- <div>
            <div ng-include="'produit/produitView.html'"></div>
        </div>  -->
    </div>
