...
<head>
    ...
    <link rel="stylesheet" href="monCompte/mesCommandes/mesCommandesStyle.css">
</head>
...
<body>
    ...
    <div>
        ...
        <div  class="init-password">
            <div ng-include="'monCompte/mesCommandes/mesCommandesView.html'"></div>
        </div>
    ...
    <script src="monCompte/mesCommandes/mesCommandesCtrl.js"></script>
