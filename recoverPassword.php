...
<head>
    ...
    <link rel="stylesheet" href="recoverPassword/recoverPassword.css">
    ...
    <script src="recoverPassword/recoverPasswordCtrl.js"></script>
...
<body>
    ...
    <div  class="init-password">
        <div ng-include="'recoverPassword/recoverPasswordView.html'"></div>
    </div>
