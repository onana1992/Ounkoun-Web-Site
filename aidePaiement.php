...
<head>
    ...
    <title>Ounkoun:Votre centre commercial en ligne - Site de vente aux enchères</title>
    <link rel="shortcut icon" href="assets/images/logo4.gif">
    <meta property="og:description" content="la description" />
    <meta property="og:image" content="https://www.ounkoun.com/images/acer1.jpgassets/images/icone1.png" />
    ...
    <link rel="stylesheet" href="aide/paiement/paiementStyle.css">
</head>
...
<body>
    ...
    <div>
        ...
        <div  class="init-password">
            <div ng-include="'aide/paiement/paiementView.html'"></div>
        </div>
    ...
    <script src="aide/paiement/paiementCtrl.js"></script>
