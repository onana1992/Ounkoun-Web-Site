...
<head>
    ...
    <title>Validation de la réinitialisation du mot de passe</title>
    ...
    <link rel="stylesheet" href="recoverPasswordConfirm/recoverPasswordConfirm.css">
    ...
    <script src="recoverPasswordConfirm/recoverPasswordConfirmCtrl.js"></script>
...
<body>
    ...
    <div  class="init-password">
        <div ng-include="'recoverPasswordConfirm/recoverPasswordConfirmView.html'"></div>
    </div>
