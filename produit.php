...
<head>
    ...
    <?php 
           ...
           $url = "https://node16375-ounkoun1.hidora.com/backend/web/app_dev.php/product/model1/";
          ...
          // print_r($result);
           //echo ($result->data->product->idImage);
          // https://node16375-ounkoun1.hidora.com/backend/web/app_dev.php/image
            $imageUrl= "https://node16375-ounkoun1.hidora.com/backend/web/app_dev.php/image/".$result->data->product->idImage;
            $url= "https://www.ounkoun.com/produit.php?nom=".$_GET['nom'];
            $description= "Commande en toute sécuriter et faite vous livrer le produit ".$_GET['nom'];
    ...
    <meta property="og:title"              content="<?php echo "acheter le ".$_GET['nom'];?>" />
    ...
    <script type="text/javascript">
        ...
        if(screen.width<800){
            window.location="https://www.ounkoun.com/m/#/produit/"+getUrlVars()["nom"];
        }
    </script>
