...
<head>
    ...
    <title><?php echo $_GET['marque']." aux meilleurs prix chez Ounkoun Cameroun";?></title>
    <script type="text/javascript">
        ...
        if(screen.width<800){
            window.location="https://www.ounkoun.com/m/#/marque/"+getUrlVars()["marque"];
        }   
    </script>
    ...
    <link rel="stylesheet" href="produitParMarque/produitParMarqueStyle.css">
    ...
    <script src="produitParMarque/produitParMarqueCtrl.js"></script>
...
<body>
    ...
    <div>
        <div ng-include="'produitParMarque/produitParMarqueView.html'"></div>
    </div>
