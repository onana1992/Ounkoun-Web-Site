...
<head>
    ...
    <title><?php echo $_GET['cat']." au meilleure prix chez Ounkoun Cameroun";?></title>
    <script type="text/javascript">
        ...
        if(screen.width<800){
            window.location="https://www.ounkoun.com/m/#/categorie/"+getUrlVars()["cat"];
        }
    </script>
    ...
    <link rel="stylesheet" href="Categorie/categorieStyle.css">
    ...
    <script src="categorie/categorieCtrl.js"></script>
...
<body>
    ...
    <div>
        <div ng-include="'categorie/categorieView.html'"></div>
    </div>
