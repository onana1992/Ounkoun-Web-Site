...
<head>
    ...
    <meta property="og:image" content="assets/images/icone1.png" />
    <title>Ounkoun:Votre centre commercial en ligne - Site de ventes aux enchères</title>
    <!-- <link rel="shortcut icon" href="assets/images/logo4.gif"> -->
    <link rel="shortcut icon" href="assets/images/icone1.png"> 
    <script type="text/javascript">
         if(screen.width<800){
     window.location="https://www.ounkoun.com/m";
    }
    ...
    <link rel="stylesheet" href="inscription/inscriptionStyle.css"> 
...
<body>
    ...
    <div style="background-color: #f5f5f5;">
        ...
        <div ng-include="'home/homeView.html'"> 
        </div>


        <div class="meslien" style="position:absolute; left: 100px:; top: -200px; color:red; ">
        ...
        <!-- <div ng-include="'foot/foot.html'" style="position:absolute;top:100%;width:100%;"> 
        </div>  -->
