...
<head>
    ...
    <link rel="stylesheet" href="aide/livraison/livraisonStyle.css">
</head>
...
<body>
    ...
    <div>
        ...
        <div  class="init-password">
            <div ng-include="'aide/livraison/livraisonView.html'"></div>
        </div>
    ...
    <script src="aide/livraison/livraisonCtrl.js"></script>
